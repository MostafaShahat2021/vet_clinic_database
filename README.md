...
**[Vet Clinic]** is a database for storing information about:
- animal
- animals' owners
- clinic employees
- visits
...
```sh
  cd my-folder
  git clone https://github.com/MostafaShahat2021/vet_clinic_database.git
```
...
- **[Can I use this project for my website?]**
  ...
  - [Sure It's MIT license, feel free to use as you like]
